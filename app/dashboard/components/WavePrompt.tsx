...
export function WavePrompt({ durationSeconds }: { durationSeconds: number | null }) {
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="flex w-full items-center gap-3">
          ...
          <div
            ...
            className="relative aspect-square flex-1 cursor-crosshair touch-none select-none rounded-lg border border-th-border bg-th-bg"
          >
          ...
          <p className="w-12 shrink-0 text-xs leading-tight text-th-muted">
            Totally<br />Tubular
          </p>
        </div>
        ...
        <button
          ...
          className="mt-2 w-full rounded-lg bg-th-btn px-4 py-2.5 text-sm font-medium text-th-btn-text transition-colors hover:bg-th-btn-hover disabled:opacity-40"
        >
